import { Container, Grid, InputLabel, Typography,Button } from "@material-ui/core";
    ...
    <Auth>
      <Container align="center" maxWidth="md">
        ...
        <Grid item xs={4}>
            ...
            <Typography>Book Name: <strong>{bookData?.title}</strong></Typography>
          </Grid>
          <Grid item xs={4}>
          <Typography>Author: <strong>{bookData?.author}</strong></Typography>
          </Grid>
          <Grid item xs={4}>
          <Typography>Contributor: <strong>{bookData?.contributor}</strong></Typography>
          </Grid>
          <Grid style={{marginTop:30}} item xs={4}>
          <Typography>Narrator: <strong>{bookData?.narrator}</strong></Typography>
          </Grid>
          <Grid style={{marginTop:30}} item xs={4}>
          <Typography>Chapter Name: <strong>{chapter?.title}</strong></Typography>
          </Grid>
